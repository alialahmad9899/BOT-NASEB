...
- 🔐 صلاحيات Owner / Manager / Viewer.
- 📊 إحصائيات وسجل عمليات.
- 💾 نسخة احتياطية JSON مع استعادة محمية.
...
2. يصل إشعار للأدمن مع Telegram User ID واسم الحساب وUsername إن وجد ورقم الإعلان ورقم الطلب وWhatsApp.
3. الخطّابة تتواصل مع العميل على WhatsApp وتشرح له طريقة الدفع.
4. الأدمن يؤكد الدفع يدوياً عند استلامه.
5. يمكن متابعة دورة التواصل: جديد ← تم التواصل ← مفتوح ← مكتمل.
6. لا يوجد إدخال لرقم عملية دفع في الواجهة الحالية.
...
- Inline buttons فقط في واجهات الأدمن والعميل، بدون Reply Keyboard سفلي.
