...
- partner_requirements: كل شروط الشريك المطلوب. رتّبها داخل النص على أسطر معنونة عندما يكون ذلك مفيداً، مثل «العمر: ...»، «مكان السكن: ...»، «الجنسية والديانة: ...»، «الصفات: ...»، «العمل: ...» وغيرها بحسب المعلومات الموجودة. لا تضف أي شرط غير موجود.
