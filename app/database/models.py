"""SQLAlchemy models for public profiles, private contacts, and manual orders."""
...
class Order(Base):
    ...
    profile_id: Mapped[int] = mapped_column(ForeignKey("profiles.id", ondelete="RESTRICT"), index=True, nullable=False)
