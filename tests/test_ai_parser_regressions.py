...
def test_real_world_syrian_marriage_text_extracts_age_and_does_not_call_phrase_a_name():
    raw = """بنت من سوريا
عمري 20 من دمشق
بدي شب منيح ما بدخن وطويل رقمي 0948484848"""
    ...
    assert parsed.partner_requirements == "بدي شب منيح ما بدخن وطويل رقمي 0948484848"
